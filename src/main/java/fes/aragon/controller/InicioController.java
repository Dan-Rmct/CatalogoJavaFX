...
public class InicioController {
    ...
    @FXML
    void abrirRacionales(ActionEvent event) { ventana("/fes/aragon/xml/racionales.fxml");}
    ...
    void accionAbrirJuego(ActionEvent event) {
        try {
            FXMLLoader modificar= new FXMLLoader(getClass().getResource("/fes/aragon/xml/PacMan.fxml"));
           ...
           ((PacmanController)modificar.getController()).setEscena(scene);
           ((PacmanController)modificar.getController()).iniciar();
            stage.show();
            stage.requestFocus();
